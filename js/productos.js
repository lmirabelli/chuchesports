...
camisetas.push(new producto('remera deportiva','adidas','S','negra','...','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
...
camisetas.push(new producto('camiseta futbol','seleccion argentina','M','violeta','rodrigo de paul','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('camiseta futbol','seleccion argentina','M','celeste y blanca','lionel messi','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('camiseta futbol','seleccion argentina','M','celeste y blanca','rodrigo de paul','https://i.ibb.co/n8F2Tgp/nophoto.png',precio1,Math.random()))
camisetas.push(new producto('remera deportiva','adidas','M','Bordo','...','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
...
//TALLE L
camisetas.push(new producto('camiseta basket','LA Lakers','L','uniforme alternativo','james','https://i.ibb.co/n8F2Tgp/nophoto.png',precio2,Math.random()))
...
camisetas.push(new producto('camiseta basket','golden state','L','uniforme alternativo','curry','https://i.ibb.co/n8F2Tgp/nophoto.png',precio2,Math.random()))
camisetas.push(new producto('remera deportiva','adidas','L','azul','...','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))

//TALLE XL
camisetas.push(new producto('camiseta futbol','seleccion argentina','XL','celeste y blanca','lionel messi','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('camiseta futbol','seleccion argentina','XL','celeste y blanca','lionel messi','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('camiseta futbol','seleccion argentina','XL','celeste y blanca','lionel messi','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
...
camisetas.push(new producto('camiseta futbol','seleccion argentina','XL','violeta','rodrigo de paul','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
...
camisetas.push(new producto('remera deportiva','adidas','XL','azul francia','...','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('camiseta futbol','seleccion argentina','XL','celeste y blanca','julian alvarez','https://i.ibb.co/n8F2Tgp/nophoto.png',precio1,Math.random()))
...
camisetas.push(new producto('camiseta futbol','seleccion argentina','XXL','celeste y blanca','lionel messi','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('camiseta futbol','seleccion argentina','XXL','celeste y blanca','lionel messi','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('camiseta futbol','seleccion argentina','XXL','celeste y blanca','lionel messi','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('camiseta futbol','seleccion argentina','XXL','violeta','lionel messi','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))
camisetas.push(new producto('remera deportiva','adidas','XXL','blanca','...','https://i.ibb.co/n8F2Tgp/nophoto.png',precio3,Math.random()))